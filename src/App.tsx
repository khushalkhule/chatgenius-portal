  ...
  useEffect(() => {
    ...
    const initApp = async () => {
      try {
        ...
        if (!localStorage.getItem('mockKnowledgeBases')) {
          localStorage.setItem('mockKnowledgeBases', JSON.stringify([]));
        }
        if (!localStorage.getItem('mockKnowledgeBaseUrls')) {
          localStorage.setItem('mockKnowledgeBaseUrls', JSON.stringify([]));
        }
        if (!localStorage.getItem('mockKnowledgeBaseFaqs')) {
          localStorage.setItem('mockKnowledgeBaseFaqs', JSON.stringify([]));
        }
        
        // You can initialize other mock data here if needed
